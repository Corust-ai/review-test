// 10 panic bugs — clear runtime hazards.
...
/// Bug 7: .expect() on a fallible parse with misleading "safe" message.
pub fn parse_port(s: &str) -> u16 {
    s.parse::<u16>().expect("safe: callers always pass valid ports")
}

/// Bug 8: slice range with potentially-out-of-bounds end.
pub fn first_n_chars(s: &str, n: usize) -> &str {
    &s[0..n]
}

/// Bug 9: multiplication overflow — panics in debug, wraps silently in release.
