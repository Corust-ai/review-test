...
/// Bug 15: mem::zeroed on NonZero — UB.
...
/// Bug 19: predictable temp file path.
pub fn cache_file(user_id: u64) -> String {
    format!("/tmp/cache-{}.bin", user_id)
}

/// Bug 20: unsafe raw pointer deref of unvalidated address.
